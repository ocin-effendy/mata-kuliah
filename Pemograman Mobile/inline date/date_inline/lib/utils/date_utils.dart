...
class DateUtils {
  ...
  static List<DateTime> daysInMonth(DateTime month) {
    var first = firstDayOfMonth(month);
		print(" ini isi ne first cokkkkk $first");
    var daysBefore = first.weekday;
		print(" ini isi ne daysbefore cokkkkk $daysBefore");
    var firstToDisplay = first.subtract(Duration(days: daysBefore));
		print(" ini isi ne firstToDisplay cokkkkk $firstToDisplay");
    var last = DateUtils.lastDayOfMonth(month);
		print(" ini isi ne last cokkkkk $last");

    var daysAfter = 7 - last.weekday;
		print(" ini isi ne daysAfter cokkkkk $daysAfter");


		print("isi last weekday =  " + " " + first.weekday.toString());
		print("isi last weekday =  " + " " + last.weekday.toString());
